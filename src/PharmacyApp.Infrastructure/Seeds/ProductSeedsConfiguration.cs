...
public static class ProductSeedsConfiguration
{
    public static IEnumerable<object> GetSeedData()
    {
        ...
        var vitamins = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Vitamin C 1000mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Vitamin D3 5000 IU",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Multivitamin Complex",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Omega-3 Fish Oil 1200mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Calcium + Magnesium",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Zinc 50mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Iron Supplement 65mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "B-Complex Vitamins",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Probiotics 10 Billion CFU",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Glucosamine Chondroitin MSM",
        ...
        var painRelief = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Ibuprofen 400mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Aspirin 500mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Paracetamol 500mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Naproxen 250mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Muscle Pain Relief Gel",
        ...
        var coldFlu = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Cold & Flu Relief Day & Night",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Cough Syrup",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Throat Lozenges",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Nasal Decongestant Spray",
        ...
        var firstAid = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Adhesive Bandages 100pk",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Sterile Gauze Pads",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Antiseptic Solution 500ml",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "First Aid Kit Deluxe",
        ...
        var skincare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Moisturizing Cream",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Acne Treatment Gel",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Sunscreen SPF 50+",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Anti-Aging Serum",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Eczema Relief Cream",
        ...
        var digestive = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Antacid Tablets",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Digestive Enzymes",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Laxative Tablets",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Anti-Diarrheal Capsules",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Fiber Supplement 300g",
        ...
        var babyCare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Baby Vitamin D Drops",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Infant Fever Reducer",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Baby Nasal Aspirator",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Diaper Rash Cream",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Baby Probiotics Drops",
        ...
        var medicalDevices = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Digital Blood Pressure Monitor",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Digital Thermometer",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Pulse Oximeter",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Nebulizer Machine",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Wrist Blood Pressure Monitor",
        ...
        var eyeCare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Lubricating Eye Drops",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Antihistamine Eye Drops",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Contact Lens Solution 360ml",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Eye Vitamins Complex",
        ...
        var oralCare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Whitening Toothpaste",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Antibacterial Mouthwash 500ml",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Dental Floss 50m",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Sensitive Toothpaste",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Electric Toothbrush Heads 4pk",
        ...
        var personalCare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Antiperspirant Deodorant",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Medicated Shampoo",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Hand Sanitizer 250ml",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Foot Cream with Urea",
        ...
        var womensHealth = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Prenatal Vitamins",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Evening Primrose Oil 1000mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Cranberry Extract Capsules",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Menopause Support Formula",
        ...
        var mensHealth = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Men's Multivitamin",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Saw Palmetto 320mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Testosterone Support Complex",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Creatine Monohydrate 250g",
        ...
        var diabetesCare = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Blood Glucose Test Strips 50pk",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Digital Glucose Meter",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Lancets 100pk",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Diabetic Foot Cream",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Alpha Lipoic Acid 600mg",
        ...
        var heartHealth = new object[]
        {
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "CoQ10 200mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Magnesium Glycinate 400mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Red Yeast Rice Extract",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Hawthorn Berry 600mg",
            ...
            new
            {
                Id = productId++, ProductCode = $"PRD-{productId - 1:D6}", Name = "Omega-3 Triple Strength",
