...
public class WishlistRepository : IWishlistRepository
{
    ...
    public async Task<List<WishlistModel>> GetByUserIdAsync(string userId)
    {
    ...
    public async Task<WishlistModel> AddAsync(WishlistModel wishlist)
    {
    ...
    // Admin specific
    public async Task<List<WishlistModel>> GetUsersByProductIdAsync(int productId)
    {
        return await _dbContext.Wishlists
            .Include(w => w.User)
